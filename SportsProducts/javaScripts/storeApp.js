//Variables
let productArray = [
  { productName: "SoccerBall", productInfo: "Made in spain", productPrice: 5000, productImg:"images/sp3488-90_2022_05_1.jpg", numProduct:1},
  { productName: "VollyBall", productInfo: "Made in china", productPrice: 2000, productImg:"images/Volleyball-1.png", numProduct:1},
  { productName: "TennisBall", productInfo: "Made in italy", productPrice: 6668, productImg:"images/tennis-ball-png-picture-1_fac9182f-2454-42e2-a5de-b9225d1f0dbf.webp", numProduct:1},
  { productName: "BasketBall", productInfo: "Made in canada", productPrice: 7895, productImg:"images/Basketball.png", numProduct:1},
]
...
let buyallBtn = document.getElementById("buybtn")
productArray.forEach(function (products) {
  ...
  searchBoxElem.addEventListener("keypress", function(event){
    let searchBoxValue = searchBoxElem.value
    if(searchBoxValue === products.productName){
      let productRect = product.getBoundingClientRect();
      let pageY = productRect.top + window.scrollY;
      let pageX = productRect.x + window.scrollX;
      console.log(pageY);
      product.style.backgroundColor = 'darkgray';
...
function addtobasket(products){
  ...
  bi.className = 'bi';
  bi.innerHTML = products.productInfo;
  bi.style.opacity = "40%"
  bi.style.fontFamily = "sans-serif"
